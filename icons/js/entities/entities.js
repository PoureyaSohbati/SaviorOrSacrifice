...
game.PlayerEntity = me.Entity.extend({
  ...
  init: function(x, y, settings) {
    ...
    // else
    //   console.log("adsf");
    console.log("curr: " + me.levelDirector.getCurrentLevelId());
    console.log("prev: " + currentLevel);
    console.log("from: " + levelFromTo[1].level.from);
    console.log("to: " + levelFromTo[1].level.to);
...
game.CreditsEnding = me.CollectableEntity.extend({
  ...
  onCollision : function (response, other) {
    // do something when collected
    // play a "eating collected" sound
    if(response.a.type === 'player' && player.hasKey){
